...
[![CI](https://github.com/hulamanisrinish-cpu/scrypted-/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/hulamanisrinish-cpu/scrypted-/actions/workflows/ci.yml)
...
Scrypted has active communities on [Discord](https://discord.gg/DcFzmBHYGq), [Reddit](https://reddit.com/r/scrypted), and [Github Discussions](https://github.com/hulamanisrinish-cpu/scrypted-/discussions). Check them out if you have questions!
...
# check out the code
git clone https://github.com/hulamanisrinish-cpu/scrypted-.git
cd scrypted-
