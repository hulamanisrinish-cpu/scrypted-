...
This plugin is based on [Hikvision Plugin for Scrypted](https://www.npmjs.com/package/@scrypted/hikvision), which is part of the [Scrypted](https://github.com/hulamanisrinish-cpu/scrypted-) project.
...
The optimal/reliable codec settings can be found in the documentation for the [Homekit Plugin](https://github.com/hulamanisrinish-cpu/scrypted-/tree/main/plugins/homekit).
