...
// Alexa skill credentials are provided via environment variables at build time.
// Scrypted's cloud build injects these; self-hosted builds should supply their own.
